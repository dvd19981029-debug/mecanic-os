...
function renderVentaRapida(container) {
    ...
    const DEPARTAMENTOS_CODES = {
        "Ahuachapán": "01", "Santa Ana": "02", "Sonsonate": "03", "Chalatenango": "04",
        "La Libertad": "05", "San Salvador": "06", "Cuscatlán": "07", "La Paz": "08",
        "Cabañas": "09", "San Vicente": "10", "Usulután": "11", "San Miguel": "12",
        "Morazán": "13", "La Unión": "14"
    };
...
<body>
    ...
    <div class="receipt-container">
        ...
        <div class="text-center" style="font-size: 10px; color: #555; margin-top: 10px;">
            <p>Representación Gráfica de un DTE</p>
            <p>¡Gracias por su preferencia!</p>
        </div>
    </div>
</body>
    ...
    async function viewDtePdf(dteId) {
        try {
            ...
            if (isSimulated) {
                ...
                alert("En modo de simulación, no hay un PDF real. Con tu API Key real en producción, este botón abrirá la representación gráfica oficial.");
                return;
            }

            if (!baseUrl) {
                showToast("Error: Configure la URL de su servidor backend proxy en Ajustes.", "danger");
                return;
            }
