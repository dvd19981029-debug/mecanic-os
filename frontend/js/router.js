...
import { renderConfiguracion } from './views/configuracion.js?v=79';
...
import { renderPresupuestos } from './views/presupuestos.js?v=91';
import { renderKanban } from './views/kanban.js?v=69';
import { renderFacturador } from './views/facturador.js?v=91';
import { renderVentaRapida } from './views/venta_rapida.js?v=79';
