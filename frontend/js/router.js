...
import { renderClientesVehiculos } from './views/clientes_vehiculos.js?v=86';
import { renderRevision21 } from './views/revision21.js?v=77';
import { renderPresupuestos } from './views/presupuestos.js?v=87';
import { renderKanban } from './views/kanban.js?v=69';
import { renderFacturador } from './views/facturador.js?v=85';
...
import { renderGastos } from './views/gastos.js?v=86';
