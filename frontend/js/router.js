...
import { renderPresupuestos } from './views/presupuestos.js?v=72';
import { renderKanban } from './views/kanban.js?v=69';
import { renderFacturador } from './views/facturador.js?v=70';
import { renderVentaRapida } from './views/venta_rapida.js?v=70';
