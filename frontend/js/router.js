...
import { renderPresupuestos } from './views/presupuestos.js?v=74';
import { renderKanban } from './views/kanban.js?v=69';
import { renderFacturador } from './views/facturador.js?v=73';
import { renderVentaRapida } from './views/venta_rapida.js?v=73';
