        ...
        container.innerHTML = html`
            <div style="max-width: 450px; margin: 8rem auto; padding: 3rem; text-align: center; background: var(--bg-sidebar); border: 1px solid var(--border-color); border-radius: var(--radius-md); box-shadow: 0 10px 25px rgba(0,0,0,0.3);">
                ...
                <div style="margin-top: 2rem;">
                    <button id="btn-lock-sync-disconnect" class="btn btn-secondary" style="font-size: 0.8rem; padding: 0.5rem 1rem;"><i class="fa-solid fa-arrow-right-from-bracket"></i> Cancelar / Desconectar</button>
                </div>
            </div>
        `;
        
        const syncDisconnectBtn = container.querySelector('#btn-lock-sync-disconnect');
